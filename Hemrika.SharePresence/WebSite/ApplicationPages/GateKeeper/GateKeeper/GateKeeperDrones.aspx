...
<%@ Register TagPrefix="SharePresence" TagName="gkdronebl" Src="/_controltemplates/15/Hemrika/GateKeeper/DroneBL.ascx" %>
<%@ Import Namespace="Microsoft.SharePoint" %>
<%@ Assembly Name="Microsoft.Web.CommandUI, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GateKeeperDrones.aspx.cs" Inherits="Hemrika.SharePresence.WebSite.GateKeeper.GateKeeperDrones" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <div class="tabs" style="width: 1000px; margin: 30px auto">
        ...
        <!-- tab containers -->
        <div id="dbl">
            <SharePresence:gkdronebl ID="gkdronebl" runat="server" />
        </div>
    </div>
