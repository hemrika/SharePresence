...
<%@ Register TagPrefix="SharePresence" TagName="GateKeeperConfig" Src="/_controltemplates/15/Hemrika/GateKeeper/GateKeeperConfig.ascx" %>
<%@ Import Namespace="Microsoft.SharePoint" %>
<%@ Assembly Name="Microsoft.Web.CommandUI, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GateKeeperManage.aspx.cs" Inherits="Hemrika.SharePresence.WebSite.GateKeeper.GateKeeperManage" DynamicMasterPageFile="~masterurl/default.master" %>
...
<div data-role="page" class="type-interior" data-theme="b">
    ...
    <div class="tabs" style="width: 1000px; margin: 30px auto">
        ...
        <!-- tab containers -->
        <div id="config">
            <SharePresence:GateKeeperConfig ID="gkConfig" runat="server" />
        </div>
    </div>
        </div><!--/content-primary -->
    </div><!-- /content -->
