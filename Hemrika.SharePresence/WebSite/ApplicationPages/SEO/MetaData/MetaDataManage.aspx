...
<%@ Register TagPrefix="SharePresence" TagName="MetaData" Src="/_controltemplates/15/Hemrika/MetaData/ManageMetaDataSettings.ascx" %>
<%@ Import Namespace="Microsoft.SharePoint" %>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MetaDataManage.aspx.cs"Inherits="Hemrika.SharePresence.WebSite.MetaData.MetaDataManage" DynamicMasterPageFile="~masterurl/default.master" %>
...
<div data-role="page" class="type-interior" data-theme="b">
    <div data-role="content" data-theme="b">
        <div class="content-primary">
            <SharePresence:MetaData ID="ManageMetaData" runat="server" ></SharePresence:MetaData>
        </div><!--/content-primary -->
    </div><!-- /content -->
</div><!-- /page -->
