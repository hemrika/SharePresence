...
<%@ Register TagPrefix="SharePresence" TagName="Semantic" Src="/_controltemplates/15/Hemrika/Semantic/SemanticSettings.ascx" %>
<%@ Import Namespace="Microsoft.SharePoint" %>
<%@ Assembly Name="Microsoft.Web.CommandUI, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SemanticManage.aspx.cs" Inherits="Hemrika.SharePresence.WebSite.Semantic.SemanticManage" DynamicMasterPageFile="~masterurl/default.master" %>
...
<div data-role="page" class="type-interior" data-theme="b">
    <div data-role="content" data-theme="b">
        <div class="content-primary">
            <SharePresence:Semantic ID="SiteMap" runat="server" ></SharePresence:Semantic>
        </div><!--/content-primary -->
    </div><!-- /content -->
</div><!-- /page -->
