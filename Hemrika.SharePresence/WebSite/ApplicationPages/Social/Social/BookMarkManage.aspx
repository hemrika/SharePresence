...
<%@ Register TagPrefix="SharePresence" TagName="BookMarks" Src="/_controltemplates/15/Hemrika/Social/ManageBookMarkSettings.ascx" %>
<%@ Import Namespace="Microsoft.SharePoint" %>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookMarkManage.aspx.cs"Inherits="Hemrika.SharePresence.WebSite.Social.BookMarkManage" DynamicMasterPageFile="~masterurl/default.master" %>
...
<div data-role="page" class="type-interior" data-theme="b">
    <div data-role="content" data-theme="b">
        <div class="content-primary">
            <SharePresence:BookMarks ID="ManageBookMarks" runat="server" ></SharePresence:BookMarks>
        </div><!--/content-primary -->
    </div><!-- /content -->
</div><!-- /page -->
