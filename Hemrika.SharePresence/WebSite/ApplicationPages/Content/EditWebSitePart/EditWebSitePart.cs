// <copyright file="EditWebSitePart.cs" company="Hemrika">
// Copyright Hemrika. All rights reserved.
// </copyright>
// <author>MARKETING\Administrator</author>
// <date>2012-03-02 13:55:49Z</date>
namespace Hemrika.SharePresence.WebSite
{
    ...
    /// <summary>
    /// TODO: Add comment for EditWebSitePart
    /// </summary>
    [SharePointPermission(SecurityAction.InheritanceDemand, ObjectModel = true)]
    public class EditWebSitePart : EnhancedLayoutsPage
    {
        /// <summary>
        /// Initializes a new instance of the EditWebSitePart class
        /// </summary>
        public EditWebSitePart()
        {
