...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoogleBrowsers.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.GoogleBrowsers" %>
<visual:GVPieChart ID="pie_Browsers" runat="server" Width="500" Height="300" GviTitle="Views per Browser" GviLegend="Right" GviIs3D="true" />
</br>
<visual:GVTable ID="tbl_Versions" runat="server" GviTitle="Browser Versions" Width="500px"></visual:GVTable>
