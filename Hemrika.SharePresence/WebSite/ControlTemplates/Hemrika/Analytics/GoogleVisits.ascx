...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoogleVisits.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.GoogleVisits" %>
<visual:GVAreaChart ID="area_visits" runat="server" Width="100%" Height="400" />