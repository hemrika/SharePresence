...
{
    public partial class GoogleOrganicSearch : UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            query.Filters = "filters=ga:medium==organic";
            ...
            System.Data.DataTable dt = new System.Data.DataTable("OrganicSearch");
            ...
            this.tbl_OrganicSearch.ChartData(dt);
        }
    }
}
