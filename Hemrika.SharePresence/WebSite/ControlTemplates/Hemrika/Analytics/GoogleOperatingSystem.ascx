...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoogleOperatingSystem.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.GoogleOperatingSystem" %>
...
<visual:GVTable ID="tbl_OS" runat="server" GviTitle="Operating Systems" Width="500px"></visual:GVTable>
