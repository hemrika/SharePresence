...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoogleReferringSites.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.GoogleReferringSites" %>
<visual:GVTable ID="tbl_ReferringSites" runat="server" GviTitle="Usage" Width="500px"></visual:GVTable>