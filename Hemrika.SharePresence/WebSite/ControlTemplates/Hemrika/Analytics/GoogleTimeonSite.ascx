...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoogleTimeonSite.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.GoogleTimeonSite" %>
<visual:GVTable ID="tbl_averageTime" runat="server" Width="200" GviTitle="Averige Time" />
<visual:GVAreaChart ID="area_averageTime" runat="server" Width="100%" Height="400" GviTitle="Average Time by Date" />