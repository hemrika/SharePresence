...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoogleSearchEngines.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.GoogleSearchEngines" %>
<visual:GVTable ID="tbl_SearchEngines" runat="server" GviTitle="Usage" Width="500px"></visual:GVTable>