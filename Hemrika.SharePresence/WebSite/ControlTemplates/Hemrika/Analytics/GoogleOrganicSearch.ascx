...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoogleOrganicSearch.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.GoogleOrganicSearch" %>
<visual:GVTable ID="tbl_OrganicSearch" runat="server" GviTitle="Usage" Width="500px"></visual:GVTable>