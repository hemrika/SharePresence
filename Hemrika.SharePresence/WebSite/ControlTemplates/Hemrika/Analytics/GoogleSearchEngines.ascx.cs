...
{
    public partial class GoogleSearchEngines : UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            query.Filters = "ga:medium==cpa,ga:medium==cpc,ga:medium==cpm,ga:medium==cpp,ga:medium==cpv,ga:medium==organic,ga:medium==ppc";
            ...
            System.Data.DataTable dt = new System.Data.DataTable("SearchEngines");
            ...
            this.tbl_SearchEngines.ChartData(dt);
        }
    }
}
