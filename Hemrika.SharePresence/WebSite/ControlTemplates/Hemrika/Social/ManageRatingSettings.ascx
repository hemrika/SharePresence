...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ManageRatingSettings.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.ManageRatingSettings" %>
