...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UABlackList.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.UABlackList" %>

<div class="GateKeeper" id="UABlackList">
    <div class="settings">
        <h1>UserAgent Blacklist</h1>
        <table>
            <tr>
                <td>UserAgent</td>
                <td><asp:TextBox ID="txtUserAgent" runat="server" MaxLength="50" ValidationGroup="useragent" /></td>
            </tr>
            <tr>
                <td>Comment</td>
                <td>
        ...
        <asp:RequiredFieldValidator ID="rfvUserAgent" 
                                    runat="server" 
                                    ValidationGroup="useragent" 
                                    ErrorMessage="* Enter a UserAgent" 
                                    ControlToValidate="txtUserAgent" 
                                    Display="Dynamic" 
                                    ForeColor="Maroon" />
        <br />
        <asp:GridView ID="gridUserAgent" 
                      runat="server"
                      BorderColor="Silver"
                      BorderStyle="solid"
                      BorderWidth="1px"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="UserAgent" DataField="useragent" ItemStyle-Width="150px" />
