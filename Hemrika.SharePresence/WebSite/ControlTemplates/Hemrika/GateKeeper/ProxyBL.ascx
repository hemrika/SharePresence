...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProxyBL.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.ProxyBL" %>

<div class="GateKeeper" id="ProxyBL">
    <div class="settings">
        <h1>Proxy BlackList History</h1>
        <asp:GridView ID="gridProxyBL" 
                      runat="server"
                      BorderColor="Silver"
                      BorderStyle="Solid"
                      BorderWidth="1px"
