...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IPWhiteList.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.IPWhiteList" %>
<div class="GateKeeper" id="IPWhiteList">
    <div class="settings">
        <h1>IP Address White List</h1>
        <table>
            <tr>
                <td>IP Address</td>
                <td>
