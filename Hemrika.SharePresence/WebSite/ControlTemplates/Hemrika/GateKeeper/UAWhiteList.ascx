...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UAWhiteList.ascx.cs" Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.UAWhiteList" %>

<div class="GateKeeper" id="UAWhiteList">
    <div class="settings">
        <h1>UserAgent WhiteList</h1>
        <table>
            <tr>
                <td>UserAgent</td>
