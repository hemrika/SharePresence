...
{
    public partial class IPBlackList : UserControl
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            service.GateKeeper(GateKeeperService.GateKeeperType.Black, GateKeeperService.GateKeeperListing.GateKeeper_IPAddress, txtIPAddress.Text);
