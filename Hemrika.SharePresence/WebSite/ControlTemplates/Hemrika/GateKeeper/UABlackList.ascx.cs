...
{
    public partial class UABlackList : System.Web.UI.UserControl
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            service.GateKeeper(GateKeeperService.GateKeeperType.Black, GateKeeperService.GateKeeperListing.GateKeeper_Useragent, txtUserAgent.Text);
        ...
        void LoadData()
        {
            ...
            List<SPListItem> items = GateKeeperModule.GetGateKeeperItems(GateKeeperType.Black, GateKeeperListing.GateKeeper_Useragent);
