...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DesignDataSourceEditor.ascx.cs"
    Inherits="Hemrika.SharePresence.WebSite.ControlTemplates.DesignDataSourceEditor" %>
