...
{
    public class HTML5VideoPicker : EntityEditorWithPicker
    {
        protected HyperLink upload;

        public HTML5VideoPicker()
            : base()
        {
            PickerDialogType = typeof(HTML5VideoPickerDialog);
        ...
        {
            List<HTML5VideoPickerEntity> resolvedItems = null;
            SPWeb web = null;
            ...
            try
            {
                ...
                if (item != null)
                {
                    resolvedItems = new List<HTML5VideoPickerEntity>();
                    resolvedItems.Add(new HTML5VideoPickerEntity(item));
                }
            }
            catch (Exception)
            {
        ...
        public new HTML5VideoPickerDialog PickerDialog
        {
            get
            {
                return (HTML5VideoPickerDialog)base.PickerDialog;
            }
            set
            {
        ...
        public Guid ListId
        {
            get
            {
                return new HTML5VideoPropertyBag(this.CustomProperty).ListId;
            }
        }
        ...
        public Guid WebId
        {
            get
            {
                return new HTML5VideoPropertyBag(this.CustomProperty).WebId;
            }
        }
        ...
        public Guid ItemId
        {
            get
            {
                return new HTML5VideoPropertyBag(this.CustomProperty).ItemId;
            }
        }
        ...
        public string QueryBox
        {
            get
            {
                return new HTML5VideoPropertyBag(this.CustomProperty).QueryBox;
            }
        }
        ...
        internal static string GenerateCallbackData(ArrayList entities, string errorMessage, bool doEncodeErrorMessage, char entitySeparator, int maximumHeight, bool append)
        {
            ...
            foreach (PickerEntity entity in entities)
            {
                writer.WriteRaw(entity.ToXmlData());
            }
