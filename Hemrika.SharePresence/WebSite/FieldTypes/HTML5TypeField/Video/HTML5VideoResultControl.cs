...
namespace Hemrika.SharePresence.WebSite.FieldTypes
{
    ...
    public class HTML5VideoResultControl : PickerResultControlBase
    {
        protected Table resultTable;
        protected HTML5VideoDataSet.HTML5VideosDataTable dt;
        ...
        private string[] columns = new string[7] { "Video", "Name", "Dimension", "Alt", "Keywords", "Web", "List" };
        public HTML5VideoResultControl()
        {
        }
        ...
        {
            base.RenderRowColumn(row as HTML5VideoDataSet.HTML5VideosRow, iColumn, parent);
        }
