...
namespace Hemrika.SharePresence.WebSite.Modules.WebPageModule.Filters
{
    ...
    /// </summary>
    public class WebPageScriptFilter : WebPageBaseFilter
    {
        ...
        public WebPageScriptFilter(HttpResponse response)
        {
        ...
        {
            string output = WebPageScriptCombine.CombineScriptBlocks(this.scriptBlocks.ToString());
