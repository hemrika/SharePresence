...
namespace Hemrika.SharePresence.WebSite.Modules.WebPageModule.Filters
{
	...
	/// </summary>
	public class WebPageInlineScriptFilter : WebPageBaseFilter
	{
		/// <summary>
        ...
        public WebPageInlineScriptFilter(HttpContext context)
		{
        ...
        protected override void Process(byte[] buffer, int offset, int count)
        {
            ...
            foreach (Match match in matches)
            {
                ...
                {
                    html = html.Replace(style, WebPageProcessor.RemoveWhiteSpaceFromJavaScript(style));
                }
            }
