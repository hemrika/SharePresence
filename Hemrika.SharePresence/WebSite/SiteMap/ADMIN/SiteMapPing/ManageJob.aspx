...
<%@ Page Language="C#" Inherits="Hemrika.SharePresence.WebSite.SiteMap.ManageJob" MasterPageFile="~/_admin/admin.master" %>
...
<asp:Content contentplaceholderid="PlaceHolderPageTitle" runat="server">
	<SharePoint:EncodedLiteral runat="server" text="Manage SiteMap Ping" EncodeMethod='HtmlEncode'/>
</asp:content>
