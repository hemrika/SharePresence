...
//  </auto-generated>
// ------------------------------------------------------------------------------
namespace Hemrika.SharePresence.WebSite.SiteMap.Index
{
    using System;
    ...
    public partial class sitemapindex
    {
        ...
        private List<tSitemap> sitemapField;

        private static System.Xml.Serialization.XmlSerializer serializer;

        public sitemapindex()
        {
            this.sitemapField = new List<tSitemap>();
        }

        [System.Xml.Serialization.XmlElementAttribute("sitemap", Order = 0)]
        public List<tSitemap> sitemap
        {
            get
            {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(sitemapindex));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current sitemapindex object into an XML document
        /// </summary>
        ...
        public static sitemapindex Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((sitemapindex)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        /// <summary>
        /// Serializes current sitemapindex object into file
        /// </summary>
        ...
        public static sitemapindex LoadFromFile(string fileName)
        {
            return LoadFromFile(fileName, Encoding.UTF8);
        }

        public static sitemapindex LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
    ...
    public partial class tSitemap
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(tSitemap));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current tSitemap object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize(System.Text.Encoding encoding)
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an tSitemap object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output tSitemap object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out tSitemap obj, out System.Exception exception)
        {
            exception = null;
            obj = default(tSitemap);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out tSitemap obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static tSitemap Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((tSitemap)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        /// <summary>
        /// Serializes current tSitemap object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an tSitemap object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output tSitemap object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out tSitemap obj, out System.Exception exception)
        {
            exception = null;
            obj = default(tSitemap);
            try
        ...
        public static bool LoadFromFile(string fileName, out tSitemap obj, out System.Exception exception)
        {
            return LoadFromFile(fileName, Encoding.UTF8, out obj, out exception);
        }

        public static bool LoadFromFile(string fileName, out tSitemap obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static tSitemap LoadFromFile(string fileName)
        {
            return LoadFromFile(fileName, Encoding.UTF8);
        }

        public static tSitemap LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try
