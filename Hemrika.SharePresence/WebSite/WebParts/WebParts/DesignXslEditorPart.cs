...
namespace Hemrika.SharePresence.WebSite.WebParts
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class DesignXslEditorPart : EditorPart
    {
        ...
        {
            var part = (DesignWebPart)WebPartToEdit;
            part.DesignType = ddl_Controls.SelectedValue;
            part.DesignStyle = ddl_Style.SelectedValue;
            part.Title = part.DesignType + " - " + part.DesignStyle;
            return true;
        }
        ...
        public override void SyncChanges()
        {
            EnsureChildControls();
            var part = (DesignWebPart)WebPartToEdit;
            SyncControls(part.DesignType);
            //ddl_Controls.SelectedValue = part.ControlType;
            SyncStyles(part.DesignStyle);
            //ddl_Style.SelectedValue = part.ControlStyle;
        }
