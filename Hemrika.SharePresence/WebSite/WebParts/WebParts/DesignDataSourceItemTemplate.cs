...
namespace Hemrika.SharePresence.WebSite.WebParts
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class DesignDataSourceItemTemplate : ITemplate
    {
        ...
        void delete_DataBinding(object sender, EventArgs e)
        {
            ...
            delete.OnClientClick = "DeleteDesignDataDialog(" + Utilities.SerializeObject(source) + ");return false;";
        }
        ...
        void edit_DataBinding(object sender, EventArgs e)
        {
            ...
            DesignDataSource source = container.DataItem as DesignDataSource;
            edit.OnClientClick = "OpenDesignDataDialog(" + Utilities.SerializeObject(source) + ");return false;";
