...
namespace Hemrika.SharePresence.Common.Logging
{
    /// <summary>
    ...
    public class SharePointLogger : BaseLogger
    {
                                                      ...
                                                      string category)
        {
            ...
            {
                string logMessage = string.Format(CultureInfo.CurrentCulture, Resources.ErrorWritingTrace, message);
        ...
        {
            string errorMessage = Resources.LoggingExceptionMessage1;
            ...
            if (errorLogException != null)
            {
                ...
                errorMessage += Resources.LoggingExceptionMessage2 + exceptionMessage + Resources.LoggingExceptionMessage3 + originalMessage;
