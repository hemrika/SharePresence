    ...
    public partial class Service : IService, IVersionAware
    {
        ...
        public AtomFeed Query(FeedQuery feedQuery)
        {
            ...
            try
            {
                ...
                //targetUri = new Uri(feedQuery.BaseAddress,true);
            }
        ...
        public RootObject JSON(FeedQuery feedQuery)
        {
            ...
            if (responseStream != null)
            {
                ...
                json = serializer.Deserialize<RootObject>(response);
                //String gets = Encoding.UTF8.GetString(responseStream.b); 
                //StreamReader response = new StreamReader(responseStream);

                //serializer.Deserialize<RootObject>(responseStream);
                //feed = CreateAndParseFeed(responseStream, feedQuery.Uri);
            }
            //Tracing.TraceCall("Exit");
            return json;
