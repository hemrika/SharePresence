...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ...
    <SharePoint:ListProperty Property="Title" runat="server"/> - <SharePoint:EncodedLiteral runat="server" text="<%$Resources:wss,listformtitle_newitem%>" EncodeMethod='HtmlEncode'/>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitleInTitleArea" runat="server">
    ...
    <span id="onetidTextTitle"><id id="L_NewItem"><SharePoint:EncodedLiteral runat="server" text="<%$Resources:wss,listformtitle_newitem%>" EncodeMethod='HtmlEncode'/></id></span>
