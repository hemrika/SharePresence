...
<div style="height:100%; width:100%; padding-left: 2px; padding-top: 16px; padding-bottom: 4px;">
...
<SharePoint:UIVersionedContent UIVersion="3" runat="server">
<ContentTemplate>
<div style="padding-left: 2px; padding-bottom: 10px;">
<asp:literal runat="server" Text="<%$Resources:Microsoft.Office.Server.Search, Search_Advanced_Page_Title%>" />
</ContentTemplate>
</SharePoint:UIVersionedContent>
<SharePoint:UIVersionedContent UIVersion="4" runat="server">
<ContentTemplate>
